...
class DlgAdvOptions:
    def __init__(self,current_kf,animation,parent):
        ...
        self.tbl_main = Gtk.Grid()
        self.tbl_main.set_row_spacing(10)
        self.tbl_main.set_column_spacing(10)
        self.tbl_main.set_property("margin", 10)

        dirs = animation.get_directions(self.current_kf)

        self.lbl_xy = Gtk.Label(label="XY angles interpolation direction:")
        self.tbl_main.attach(self.lbl_xy,0,0,1,1)
        ...
        self.tbl_main.attach(self.cmb_xy,1,0,1,1)
        self.lbl_xz = Gtk.Label(label="XZ angles interpolation direction:")
        self.tbl_main.attach(self.lbl_xz,0,1,1,1)
        ...
        self.tbl_main.attach(self.cmb_xz,1,1,1,1)
        self.lbl_xw = Gtk.Label(label="XW angles interpolation direction:")
        self.tbl_main.attach(self.lbl_xw,0,2,1,1)
        ...
        self.tbl_main.attach(self.cmb_xw,1,2,1,1)
        self.lbl_yz = Gtk.Label(label="YZ angles interpolation direction:")
        self.tbl_main.attach(self.lbl_yz,0,3,1,1)
        ...
        self.tbl_main.attach(self.cmb_yz,1,3,1,1)
        self.lbl_yw = Gtk.Label(label="YW angles interpolation direction:")
        self.tbl_main.attach(self.lbl_yw,0,4,1,1)
        ...
        self.tbl_main.attach(self.cmb_yw,1,4,1,1)
        self.lbl_zw = Gtk.Label(label="ZW angles interpolation direction:")
        self.tbl_main.attach(self.lbl_zw,0,5,1,1)
        ...
        self.tbl_main.attach(self.cmb_zw,1,5,1,1)
